...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link ">
        <main id="js-page-content" role="main" class="page-content">
          ...
          // Многомерный массив в который мы уже передали путь к изображению из нашей папки student
          ?>
                ...
                <?php endforeach;?>
    <!-- Используя цикл foreach мы передали из массива нужный путь к каждой картинке!-->
                <!--
