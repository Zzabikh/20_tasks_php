...
?>
<!--На этот раз мы уже соединились с базой данных и уже оттуда мы передаём информацию в цикл foreach-->
                       ...
                       <?php foreach($users as $user): ?>
                            <div class="<?php echo $user['status'] == 'banned' ? 'banned' : '' ?> rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                ...
                                <?php endforeach;?>
<!-- Используя цикл foreach, мы вывели всю информцию из базы данных в один экземпляр аккаунта твиттера. Выводя из этого массива нужное нам значение. Скажем для ника "user", для аватарки "image", для професии "work" и т д-->
